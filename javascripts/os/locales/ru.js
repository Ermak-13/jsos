var ru = {
  'configurator.dialog.title': '%(widgetName)s - Настройки',
  'configurator.submit.value': 'Сохранить',

  'position_and_size_form.nav_text': 'Позиция и размер',
  'position_and_size_form.width.label': 'ширина:',
